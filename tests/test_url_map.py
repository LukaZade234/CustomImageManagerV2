...
EXPECTED_ROUTES = {
    ...
    ("/api/moderation/claims", "GET"),
    ("/api/moderation/claims/<int:claim_id>/decide", "POST"),
    ("/api/moderation/claims/approve-all/<ref>", "POST"),
    ("/api/moderation/cutover", "GET"),
